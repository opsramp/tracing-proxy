...
func request_TraceProxyService_ExportTraceProxy_0(ctx context.Context, marshaler runtime.Marshaler, client TraceProxyServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ExportTraceProxyServiceRequest
	...
	msg, err := client.ExportTraceProxy(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_TraceProxyService_ExportTraceProxy_0(ctx context.Context, marshaler runtime.Marshaler, server TraceProxyServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ExportTraceProxyServiceRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ExportTraceProxy(ctx, &protoReq)
	return msg, metadata, err
...
// UnaryRPC     :call TraceProxyServiceServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterTraceProxyServiceHandlerFromEndpoint instead.
func RegisterTraceProxyServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TraceProxyServiceServer) error {
	...
	mux.Handle("POST", pattern_TraceProxyService_ExportTraceProxy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.TraceProxyService/ExportTraceProxy", runtime.WithHTTPPathPattern("/trace-proxy/api/v7/tenants/{tenantId}/traces"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TraceProxyService_ExportTraceProxy_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_TraceProxyService_ExportTraceProxy_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTraceProxyServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterTraceProxyServiceHandler(ctx, mux, conn)
}
...
func RegisterTraceProxyServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterTraceProxyServiceHandlerClient(ctx, mux, NewTraceProxyServiceClient(conn))
}

// RegisterTraceProxyServiceHandlerClient registers the http handlers for service TraceProxyService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "TraceProxyServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "TraceProxyServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "TraceProxyServiceClient" to call the correct interceptors.
func RegisterTraceProxyServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TraceProxyServiceClient) error {
	...
	mux.Handle("POST", pattern_TraceProxyService_ExportTraceProxy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.TraceProxyService/ExportTraceProxy", runtime.WithHTTPPathPattern("/trace-proxy/api/v7/tenants/{tenantId}/traces"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TraceProxyService_ExportTraceProxy_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
